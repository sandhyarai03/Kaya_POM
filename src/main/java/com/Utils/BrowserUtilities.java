...
public class BrowserUtilities {
	...
	public void ufClearFieldByBackSpaceKey(WebElement ele) throws Exception {
		ele.sendKeys(Keys.BACK_SPACE, Keys.BACK_SPACE);
	}
	...
	public void unSelectCheckBox(WebElement ele) {
		boolean isSelected = ele.isSelected();
